  ...
  return (
    <div id={SECTION_TYPE.HOME} ref={ref} className="h-screen w-full flex flex-col items-center justify-center relative overflow-hidden">
      ...
      >
        <span>I{"'"}m</span>
        <div
          className="flex items-center border-dashed rounded-xl relative scale-95 ml-4"
          style={{
            boxShadow: "rgba(0, 0, 0, 0.35) 0px 10px 20px 0px"
          }}
        >
            Reynold
          ...
          <div className="w-full h-full absolute top-0 left-0 z-[0] bg-[#E9EFEC] opacity-30 rounded-xl"></div>
        </div>
      </div>
