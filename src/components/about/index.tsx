...
const contactList = [
  {
    icon: GithubSVG,
    link: "https://github.com/Trentist"
  },
  {
    icon: LinkedinSVG,
    link: "https://www.linkedin.com/in/reynold-chang-b87087359"
  },
  {
    icon: GmailSVG,
    email: "mailto:dkwebigo416@gmail.com"
  },
  {
    icon: TelegramSVG,
    link: "https://t.me/dodge_geek"
  },
  {
    icon: WhatsappSVG,
    link: "https://wa.me/+1645202266350"
  }
]
  ...
  return (
    ...
    >
      ...
      >
        ...
        Hello, I{"'"}m Reynold Chang{"("}常龙浩{")"}, a Full Stack Developer with many years of experience. Welcome to my personal space!
